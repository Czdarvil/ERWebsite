...
function assets() {
  wp_enqueue_style('font_google_pt_sans', asset_path('fonts/pt-sans.css'), false, null);
...
function admin_assets(){
  wp_enqueue_script('acf_yoast', asset_path('scripts/acf_yoast.js'), ['yoast-seo'], false, true);
}
